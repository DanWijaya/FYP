...
def parseargs():
    ...
    aa('--dataset', choices=['places', 'ucf101'], default='places')
...
def main():
    ...
    for unit in pbar(unit_list):
        ...
        # Get binary accuracy of the model after ablating the unit.
    ...
    #     pbar.descnext('validate unit %d' % idx)
    #     _, _, _, ablation_ba = test_perclass_pra(
    #             model, train_dataset,
    #             layername=layername,
    #             ablated_units=[idx],
    ...
    #                 (args.model, args.dataset, unit)))
    #     single_unit_ablation_ba[idx] = ablation_ba
